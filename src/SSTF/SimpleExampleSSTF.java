 ...
 * one cloudlet on it.
 */
public class SimpleExampleSSTF {
	...
	public static void run(String path,Calculator calculator) {
		...
		try {
			...
			DatacenterBroker broker = createMyBroker("SSTF_Broker",calculator);
			...
			System.out.println(VMPool.getVMPool());
		} catch (Exception e) {
			e.printStackTrace();
	 ...
	 */
	private static DatacenterBroker createMyBroker(String name,Calculator calculator) {
		DatacenterBroker broker = null;
		try {
			broker = new SSTFBroker(name,calculator);
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
